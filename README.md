...
Интерфейс содержит сводку, интерактивную карту всех найденных АЗС с
кластеризацией, таблицу и мобильные карточки, строку поиска и мультивыбор видов
топлива и статусов через выпадающие списки с галочками. Цвет маркера показывает
вероятностный статус, а карточка на карте — объединённые источники, топливо,
цены и свежесть. Карта и список используют одни фильтры.
